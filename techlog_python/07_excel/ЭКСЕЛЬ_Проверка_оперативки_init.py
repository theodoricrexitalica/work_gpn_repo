...
for fileXls in targetFile:
	...
	sheet_zar.Cells(1, 4).value = "6:00"
	sheet_zar.Cells(1, 5).value = "18:00"
	sheet_zar.Cells(1, 6).value = "пар_раб_м3"
	sheet_zar.Cells(1, 7).value = "пар_раб_%"
	sheet_zar.Cells(1, 8).value = "пар_раб_тн"
	for j in range(len(oilfield_name_zar)):
		...
		sheet_zar.Cells(j+2, 4).value = status_morning_zar[j]
		sheet_zar.Cells(j+2, 5).value = status_evening_zar[j]
		sheet_zar.Cells(j+2, 6).value = q_liq_zar[j]
		sheet_zar.Cells(j+2, 7).value = wc_zar[j]
		sheet_zar.Cells(j+2, 8).value = q_oil_zar[j]
	...
	sheet_zar.Columns(4).ColumnWidth = 70
	sheet_zar.Columns(4).WrapText = True
	sheet_zar.Columns(4).VerticalAlignment = -4108
	sheet_zar.Columns(5).ColumnWidth = 70
	sheet_zar.Columns(5).WrapText = True
	sheet_zar.Columns(5).VerticalAlignment = -4108
	sheet_zar.Columns(6).AutoFit()
	sheet_zar.Columns(6).NumberFormat = '0'
	sheet_zar.Columns(6).HorizontalAlignment = -4108
