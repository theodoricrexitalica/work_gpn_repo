...
#DeclarationsEnd
import os
wellhead_path = 'E:\\Petrel\\Exchange\\Tops\\welltops.txt'
ds_zone = 'ZONES_gm'																									#Указать правильно датасет с зонами
...
#path = os.path.realpath('E:\\Petrel\\Exchange\\Tops\\')
#os.startfile('E:\\Petrel\\Exchange\\Tops\\')
