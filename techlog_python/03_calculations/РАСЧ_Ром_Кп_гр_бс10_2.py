...
#Mode:In
#Description:
KPO = Variable("Rom-77R", "LQC", "td_PHIT_v2", "Porosity", "%")
parameterDict.update({'KPO' : Parameter(name='KPO',bname='kpo',type='Variable',family='Porosity',measurement='',unit='%',value='Rom-77R.LQC.td_PHIT_v2',mode='In',description='',group='',min='',max='',list='',enable='True',iscombocheckbox='False',isused='True')})
#Type:Number
#Unit:%
kpo_gr_unit = "%"
