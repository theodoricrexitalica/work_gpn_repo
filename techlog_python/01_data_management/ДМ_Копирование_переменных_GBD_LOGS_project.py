...
depth_list = []
#Обязательно выбрать скважину и нужные датасеты
for well in db.selectedWellList():
	ds_list= db.selectedDatasetList(well)
	...
	for ds in ds_list:						
		...
		for var in var_list:
			if var != "DEPT":
				print(well, ds, var)
				db.variableCopy(well, ds,var, "GDB_LOGS", var + "_" + str(ind), "automatic", "project", "project", -1, 0, 0)
